          ...
          <div className="rounded-xl w-4/5 mx-auto bg-[#DAE8FC] mt-6 ">
            <div className="pt-3 pb-3">
              ...
              >
                    ...
                    <div>
                      ...
                      <div>
                        ...
                        <input
                          ...
                          placeholder={calendar2 + " Mysterious Savanah "}
                          className="text-xl indent-4 rounded-xl shadow-inner outline-2 outline-slate-50  w-4/5"
                        />
                      </div>
                    </div>
                ...
                <div className="justify-center flex pt-5">
                  <button
                    className="bg-blue-500 hover:bg-blue-700 text-white text-2xl font-bold py-2  rounded w-1/4"
                    type="submit"
                  >
                    Next
                  </button>
            ...
            <div className="rounded-xl w-4/5 mx-auto bg-[#DAE8FC] mt-6 ">
              <div className="flex flex-col p-8 pb-4 h-96">
                ...
                {props.membersDetails.length < 5 ? (
                  <div className="flex justify-end" onClick={addMember}>
                    <svg
                      width="26"
                      height="55"
                      viewBox="0 0 46 55"
                ...
                <div className=" ml-14 flex flex-wrap overflow-hidden">
                  <div className="flex flex-col  w-1/2">
                    ...
                    {SocialLinks.length < 5 ? (
                      <div className="flex justify-end" onClick={addSocial}>
                        <svg
                          width="26"
                          height="55"
                          viewBox="0 0 46 55"
